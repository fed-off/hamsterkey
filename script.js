...
const blocks = [
    ...
    { id: 'red3', x: 3, y: 3, width: 1, height: 3, color: 'red' },
    { id: 'red4', x: 4, y: 0, width: 1, height: 3, color: 'red' },
    ...
    { id: 'green2', x: 2, y: 1, width: 2, height: 1, color: 'green' },
    { id: 'green3', x: 4, y: 3, width: 2, height: 1, color: 'green' },
    { id: 'green4', x: 0, y: 4, width: 3, height: 1, color: 'green' },
    { id: 'green5', x: 0, y: 5, width: 2, height: 1, color: 'green' },
    // { id: 'green6', x: 1, y: 5, width: 2, height: 1, color: 'green' },
