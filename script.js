...
let blockSize;
const blocks = [
    { id: 'red1', x: 1, y: 0, width: 1, height: 3, color: 'red' },
    { id: 'red2', x: 3, y: 0, width: 1, height: 2, color: 'red' },
    { id: 'red3', x: 4, y: 1, width: 1, height: 3, color: 'red' },
    { id: 'red4', x: 5, y: 4, width: 1, height: 2, color: 'red' },
    ...
    { id: 'green4', x: 0, y: 5, width: 3, height: 1, color: 'green' },
