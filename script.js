...
let blockSize;
const blocks = [
    { id: 'red1', x: 1, y: 2, width: 1, height: 3, color: 'red' },
    { id: 'red2', x: 2, y: 4, width: 1, height: 2, color: 'red' },
    { id: 'red3', x: 4, y: 1, width: 1, height: 3, color: 'red' },
    { id: 'red4', x: 5, y: 0, width: 1, height: 2, color: 'red' },
    { id: 'red5', x: 5, y: 2, width: 1, height: 2, color: 'red' },
    ...
    { id: 'green4', x: 3, y: 4, width: 3, height: 1, color: 'green' },
