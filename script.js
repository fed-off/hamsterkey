...
const blocks = [
    ...
    { id: 'red3', x: 3, y: 2, width: 1, height: 2, color: 'red' },
    ...
    { id: 'green2', x: 1, y: 0, width: 3, height: 1, color: 'green' },
    { id: 'green3', x: 1, y: 4, width: 3, height: 1, color: 'green' },
    { id: 'green4', x: 3, y: 1, width: 2, height: 1, color: 'green' },
    { id: 'green5', x: 3, y: 5, width: 2, height: 1, color: 'green' },
