...
const blocks = [
    ...
    { id: 'green1', x: 0, y: 5, width: 3, height: 1, color: 'green' },
    { id: 'green2', x: 2, y: 1, width: 3, height: 1, color: 'green' },
    { id: 'green3', x: 3, y: 3, width: 2, height: 1, color: 'green' },
    { id: 'green4', x: 4, y: 0, width: 2, height: 1, color: 'green' },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateProgressBar() {
        const now = new Date();
        const targetTime = new Date(Date.UTC(2024, 6, 30, 20));
