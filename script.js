...
const blocks = [
    ...
    { id: 'red4', x: 4, y: 2, width: 1, height: 2, color: 'red' },
    { id: 'red5', x: 5, y: 1, width: 1, height: 3, color: 'red' },
    // { id: 'red6', x: 5, y: 3, width: 1, height: 3, color: 'red' },
    { id: 'green1', x: 1, y: 3, width: 2, height: 1, color: 'green' },
    { id: 'green2', x: 1, y: 5, width: 2, height: 1, color: 'green' },
    { id: 'green3', x: 2, y: 0, width: 2, height: 1, color: 'green' },
    { id: 'green4', x: 2, y: 1, width: 3, height: 1, color: 'green' },
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function updateProgressBar() {
        const now = new Date();
        const targetTime = new Date(Date.UTC(2024, 8, 5, 20));
